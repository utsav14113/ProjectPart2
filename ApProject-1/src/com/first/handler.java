...
public class handler extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
    	...
    	df2=new SimpleDateFormat("yyyy/M/dd");
    	dateobj = new Date();
    	D3=df2.format(dateobj);
				String f1;
			...
			try{
				...
				b1.write("hello"+":"+EMAIL+":"+NAME+":"+ENO+":"+CATEGORY+":"+GENDER+":"+PD+":"+dt+":"+PHDSTREAM+":"+DEGREE+":"+ex_degree+":"+BOARD10+":"+BOARD12+":"+DEP+":"+ex_dep+":"+UNIV
					+":"+ex_college+":"+BOX4+":"+ex_state+":"+MARKS10+":"+MARKS12+":"+grad_marks+":"+p_grad_marks+":"+gate_score+":"+D3+":");
				b1.newLine();
				b1.close();
